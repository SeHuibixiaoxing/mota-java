...
public class BlueKeyEvent extends Event {
	public BlueKeyEvent(StackPane rpgScene, RpgSceneMain rpgSceneMain, int row, int line, RpgSwitch privateSwitch) {
		super(new Image(ImageData.keyBlue), rpgScene, rpgSceneMain, row, line, privateSwitch, 0);
	}
