...
public class HpBlueEvent extends Event {
	public HpBlueEvent(StackPane rpgScene, RpgSceneMain rpgSceneMain, int row, int line, RpgSwitch privateSwitch) {
		super(new Image(ImageData.hpBlue), rpgScene, rpgSceneMain, row, line, privateSwitch, 0);
	}
