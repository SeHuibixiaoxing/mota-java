...
public class RedDoorEvent extends Event {
	public RedDoorEvent(StackPane rpgScene, RpgSceneMain rpgSceneMain, int row, int line, RpgSwitch privateSwitch) {
		super(new Image(ImageData.doorRed), rpgScene, rpgSceneMain, row, line, privateSwitch, 0);
	}
	...
	@Override
	protected void work() {
		if(ModelPlayerData.keyRed.intValue() < 1) return;
